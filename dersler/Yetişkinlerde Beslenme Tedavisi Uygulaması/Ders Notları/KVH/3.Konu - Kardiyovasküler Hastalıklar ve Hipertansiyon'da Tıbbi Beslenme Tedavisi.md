...
### 1. Etiyolojik Sınıflandırma

- **Primer (Esansiyel) Hipertansiyon (%90–95):** Belirli ve tek bir ikincil hastalığa bağlı olmayan; genetik yatkınlık, yaşlanma, beslenme hataları (aşırı sodyum, düşük potasyum) ve obezite gibi çoklu faktörlerin etkileşimiyle gelişen formdur.
- **Sekonder Hipertansiyon (%5–10):** Doğrudan spesifik bir hastalığa ikincil olarak gelişir. Birincil neden tedavi edildiğinde tansiyon normale döner.
    - _Başlıca Nedenler:_ Renal Arter Stenozu (böbrek damar darlığı), Primer Aldosteronizm (Conn Sendromu), Feokromositoma (adrenal medulla tümörü), Cushing Sendromu, Uyku Apnesi ve Renal Parankim Hastalıkları.

---

### BÖLÜM 2: DETAYLI PATOGENEZ VE NÖRO-RENO-VASKÜLER MEKANİZMALAR

Kan basıncının (Arteryel Basınç - BP) temel fizyolojik denklemi şudur:

\[\text{Kan Basıncı (BP)} = \text{Kardiyak Debi (Cardiac Output - CO)} \times \text{Sistemik Vasküler Direnç (SVR)}\]

Hipertansiyon patogenezi, bu denklemdeki iki bileşenden birinin veya her ikisinin kronik olarak yükselmesiyle gerçekleşir:

```
                                  HİPERTANSİYON PATOGENEZ ÜÇGENİ
                                                │
       ┌────────────────────────────────────────┼────────────────────────────────────────┐
       ▼                                        ▼                                        ▼
[1. RENAL - RAAS EKSENİ]             [2. OTONOM SİNİR SİSTEMİ (SNS)]          [3. VASKÜLER VE ENDOTEL STRESİ]
* Renin-Anjiyotensin-Aldosteron ↑    * Sempatik overaktivite (overdrive)     * eNOS kilitlenmesi (NO çöküşü)
* Renal Na+ ve su tutulumu           * α1-adrenerjik vazokonstriksiyon       * Endotelin-1 (ET-1) yükselişi
* Kan hacmi (Volüm) artışı (CO ↑)    * β1-adrenerjik atım hızı fırlaması     * Düz kas hipertrofisi (SVR ↑)
```

### 1. Renin-Anjiyotensin-Aldosteron Sistemi (RAAS) ve Renal Volüm Kontrolü

Böbreğe giden kan akımı veya distal tübüle ulaşan sodyum azaldığında Jukstaglomerüler hücrelerden **Renin** salgılanır.

- Renin, karaciğer kaynaklı _Anjiyotensinojeni_ Anjiyotensin I'e dönüştürür. Akciğerdeki **ACE (Angiotensin Converting Enzyme)** enzimi bunu güçlü bir vazokonstriktör olan **Anjiyotensin II**'ye dönüştürür.
- **Anjiyotensin II:** Doğrudan sistemik arteriyolleri kasarak vasküler direnci (SVR) artırır; böbrek üstü bezinden **Aldosteron** salgılanmasını uyarır.
- **Aldosteron:** Nefronun distal tübül ve toplayıcı kanallarında **ENaC** kanallarını açarak **Sodyum (Na⁺) ve Su emilimini fırlatır, Potasyumu (K⁺) idrarla attırır**. Biriken sıvı venöz dönüşü artırarak Kardiyak Debiyi (CO) yükseltir.

### 2. Sempatik Sinir Sistemi (SNS) Aşırı Aktivasyonu (Sympathetic Overdrive)

Karotid ve aortik baroreseptörlerin kronik yüksek basınca adapte olarak duyarsızlaşması sonucu nörojenik sempatik deşarj artar.

- \(\alpha_1\)-adrenerjik reseptör uyarımı periferik damar düz kaslarını kasarak damar çapını daraltır (SVR \(\uparrow\)).
- \(\beta_1\)-adrenerjik reseptör uyarımı kalbin atım hızını ve kasılma gücünü artırır (CO \(\uparrow\)).
- Böbrekte sempatik uyarı Renin salınımını doğrudan tetikler.

### 3. Vasküler Remodeling ve Endotel Disfonksiyonu

Sürekli yüksek basınca maruz kalan arteriyol düz kas hücreleri kalınlaşır (_remodeling_) ve esnekliğini kaybeder. Endotelde _eNOS_ enzimi kilitlenir; Nitrik Oksit (NO) sentezi çökerken, güçlü kasıcı polipeptit olan **Endotelin-1 (ET-1)** fırlayarak damar direncini kalıcı hale getirir.

---

### BÖLÜM 3: OBEZİTE, İNSÜLİN DİRENCİ VE SODYUM DUYARLILIĞI (SALT SENSITIVITY) METABOLİZMASI

Hipertansiyon vakalarının %75'inden fazlası doğrudan obezite ve metabolik sapmalarla ilişkilidir.

```
+--------------------------------------------------------------------------------------------------------+
|                      METABOLİK SAPMALARIN HİPERTANSİYON PATOGENEZİNE ETKİLERİ                          |
+-------------------+-----------------------------------+------------------------------------------------+
| Metabolik Sapma   | Hücresel / Biyokimyasal Mekanizma | Hipertansif Sonuç                              |
+-------------------+-----------------------------------+------------------------------------------------+
| Visseral Obezite  | Karın içi yağ dokusunun böbrek    | Renal tübül basıncı artırır; sodyum atılımını  |
| (VAT Artışı)      | parankimini sıkıştırması (Compression)| engeller, RAAS'ı azdırır.            |
+-------------------+-----------------------------------+------------------------------------------------+
| İnsülin Direnci & | Renal tübüllerde Na+/K+ ATPaz ve  | Böbrekten sodyum geri emilimini fırlatır;      |
| Hiperinsülinemi   | ENaC kanallarının uyarılması.| SNS aktivasyonunu yüksek tutar.       |
+-------------------+-----------------------------------+------------------------------------------------+
| Sodyum Duyarlılığı| Natriüretik yanıtın küntleşmesi;  | Hücre içi Ca2+ birikimi ve vasküler düz kas    |
| (Salt Sensitivity)| bozulmuş böbrek sodyum atılımı.   | kasılması.                          |
+-------------------+-----------------------------------+------------------------------------------------+
| Fruktoz ve        | Fruktokinaz yolağıyla ATP kaybı;  | eNOS inhibisyonu; renal arteriyollerde kalsi-  |
| Ürik Asit Yükü    | serum Ürik Asit fırlaması.        | fikasyon ve vasküler sertleşme.                |
+--------------------------------------------------------------------------------------------------------+
```

### 1. Visseral Obezite ve Renal Kompresyon Mekanizması

Visseral yağ dokusu (VAT) karın içinde genişlediğinde böbrekleri fiziksel olarak sıkıştırır (_intrarenal kompresyon_). Renal parankim içi basınç artar; medüller kan akımı yavaşlar. Böbrek bu durumu "kanlanma azlığı" olarak algılayarak kan basıncını yükseltmek için masif Renin salgılar.

### 2. İnsülin Direnci ve Sodyum Tutulumu

Hiperinsülinemi varlığında insülin, böbreğin proximal tübüllerindeki ve toplayıcı kanallarındaki sodyum pompalarını (Na⁺/K⁺ ATPaz ve ENaC) uyararak idrarla atılması gereken sodyumu kan dolaşımına geri çeker. Ayrıca insülin, hipotalamik ventromediyal çekirdeği uyararak sempatik tonusu sürekli yüksek tutar.

### 3. Sodyum Duyarlılığı (Salt Sensitivity) ve Na/K Oranı

Sodyum alımıyla kan basıncının belirgin şekilde yükselmesi durumudur. Yaşlılarda, Afrika kökenlilerde, diyabetik, böbrek hastası ve obez bireylerde sodyum duyarlılığı riski çok yüksektir.

- **Evrimsel Na/K İnversiyonu:** Paleolitik dönem insan diyetinde sodyum alımı <1000 mg/gün iken potasyum sodyumun yaklaşık 7 katıydı. Modern Western diyette ise sodyum alımı potasyumun 3 katı seviyesine fırlamıştır.
- Hücre içinde aşırı sodyum birikimi, Na⁺/Ca²⁺ değiştiricisini etkileyerek vasküler düz kas hücresi içinde **Kalsiyum (\(Ca^{2+}\)) birikmesine** ve damarların kilitlenip kasılmasına neden olur.

---

### BÖLÜM 4: BİYOBELİRTEÇLER, ABPM VE KLİNİK TAKİP

Hipertansiyon hastasının takibinde sadece tek bir poliklinik tansiyon ölçümü yetersizdir.

```
+--------------------------------------------------------------------------------------------------------+
|                                  HİPERTANSİYON TAKİP VE BİYOBELİRTEÇ MATRİSİ                           |
+-------------------+-----------------------------------+------------------------------------------------+
| Test / Parametre  | Referans / İdeal Değer            | Klinik Anlamı ve Nüans                         |
+-------------------+-----------------------------------+------------------------------------------------+
| ABPM (24 Saatlik  | Gece kan basıncının fizyolojik    | **Non-Dipper HT:** Gece tansiyonu < %10 düşer. |
| Holter Takibi)    | olarak %10 - 20 düşmesi (Dipper). | **En ağır inme ve KVH mortalite göstergesidir!**|
+-------------------+-----------------------------------+------------------------------------------------+
| Mikroalbümünüri   | İdrarda Albümin/Kreatinin Oranı   | Erken renal mikrovasküler end-organ hasarı     |
|                   | 30 - 300 mg/g                     | göstergesidir.                                 |
+-------------------+-----------------------------------+------------------------------------------------+
| eGFR & Kreatinin  | eGFR >90 mL/dk/1.73m²             | Hipertansif nefroskleroz ve böbrek fonksiyon  |
|                   | Kreatinin: Erkek <1.3, Kadın <1.2 | kaybını gösterir.                        |
+-------------------+-----------------------------------+------------------------------------------------+
| PRA ve ARR Oranı  | Plasma Renin & Aldosteron Oranı   | Sekonder Hipertansiyon (Primer Aldosteronizm)  |
|                   |                                   | ayırıcı tanısında bakılır.                     |
+--------------------------------------------------------------------------------------------------------+
```

### Ambulatuvar Kan Basıncı Takibi (ABPM) ve Dipping Fenotipleri

- **Dipper Fenotipi (Fizyolojik):** Gece uykuda sempatik aktivite düştüğü için kan basıncı gündüze göre %10–20 oranında düşer.
- **Non-Dipper Fenotipi (Patolojik):** Gece kan basıncı düşmez (< %10 düşüş) veya fırlar (_riser_). Otonom nöropati, obezite veya böbrek hastalığı göstergesidir; **inme, sol ventrikül hipertrofisi ve organ hasarı riski en yüksek gruptur**.
- **Beyaz Önlük vs. Maskelenmiş Hipertansiyon:** Hastanın klinik ortamda tansiyonunun yüksek, evde normal çıkması _Beyaz Önlük_; klinikte normal, evde/işte yüksek çıkması _Maskelenmiş Hipertansiyondur_.

---

### BÖLÜM 5: TIBBİ BESLENME TEDAVİSİ (MNT) - DASH PROTOKOLÜ VE REÇETESİ

Hipertansiyon MNT'sinde altın standart, kanıta dayalı **DASH (Dietary Approaches to Stop Hypertension)** beslenme modelidir.

```
[DASH PROTOKOLÜ VE TBT BİLEŞENLERİ]
        │
        ├─► [1. DİYET PATERNİ (DASH Besin Grubu Dağılımı)]
        │   ├─► Meyve & Sebze: Günde 8 - 10 porsiyon (Mineral & Antioksidan kaynağı).
        │   ├─► Düşük Yağlı Süt Ürünleri: Günde 2 - 3 porsiyon (Kalsiyum & B12).
        │   ├─► Tam Tahıllar: Günde 6 - 8 porsiyon (Lif ve Magnezyum).
        │   └─► Sert Kabuklu Yemişler & Baklagiller: Haftada 4 - 5 porsiyon.
        │
        ├─► [2. MİNERAL ÜÇLÜSÜ BOMBARDIMANI]
        │   ├─► **Potasyum (K): 4700 mg/gün** (Vasküler düz kası gevşetir, sodyumu attırır).
        │   ├─► **Magnezyum (Mg): 500 mg/gün** (Doğal kalsiyum kanal blokeridir, vazodilatör).
        │   └─► **Kalsiyum (Ca): 1200 mg/gün** (Membran stabilitesi ve damar tonusu).
        │
        ├─► [3. SODYUM / TUZ KISITLAMASI PROTOKOLÜ]
        │   ├─► Genel Popülasyon Hedefi: <2300 mg/gün sodyum (~5.8 g tuz).
        │   └─► İdeal Hipertansif Hedef: **<1500 mg/gün sodyum** (~3.8 g tuz).
        │       *(Nüans: Günlük sodyumda 1000 mg'lık bir kısıtlama dahi SBP'yi 5-6 mmHg düşürür!)*
        │
        └─► [4. KİLO VE ALKOL YÖNETİMİ]
            ├─► Kilo Kaybı: Verilen her 1 kg ağırlık kaybı sistolik tansiyonu ~1 mmHg düşürür.
            └─► Alkol Kısıtlaması: Erkek ≤2 kadeh/gün, Kadın ≤1 kadeh/gün.
```

### 1. DASH Diyetinin Klinik Gücü (DASH vs. DASH-Sodium Çalışmaları)

- **DASH Çalışması:** DASH diyeti (2300-3000 mg sodyum seviyesinde dahi), hipertansif bireylerde sistolik kan basıncını ortalama **11.4 mmHg**, diyastolik kan basıncını **5.5 mmHg** düşürmüştür.
- **DASH-Sodium Çalışması:** DASH diyeti sodyum kısıtlamasıyla (<1500 mg/gün) birleştirildiğinde tansiyon düşürücü etki katlanarak maksimum seviyeye ulaşmıştır.

### 2. Mineral Üçlüsünün Etki Mekanizmaları

- **Potasyum (\(K^+\) - 4700 mg/gün):** Böbrek tübüllerinde natriürezisi (sodyum atılımını) uyarır. Vasküler düz kas hücrelerinde \(Na^+/K^+\) ATPaz pompasını uyararak hücre membranını hiperpolarize eder ve damarı genişletir.
- **Magnezyum (\(Mg^{2+}\) - 500 mg/gün):** Hücre içine kalsiyum girişini engelleyen **doğal kalsiyum kanal blokeridir**. Nitrik oksit (NO) sentezini destekler.

---

### BÖLÜM 6: DİYETİSYENLER İÇİN PRATİK KLİNİK YAKLAŞIMLAR VE SİNSİ TUZAKLAR

Poliklinikte hipertansiyon hastasını takip eden bir diyetisyenin **asla yapmaması gereken ölümcül hatalar ve pratik klinik süzgeç**:

```
[HİPERTANSİF HASTA YÖNETİM AKIŞI]
        │
        ├─► [SİNSİ TUZAK 1: "HİÇ TUZ KULLANMIYORUM" İLLÜZYONU]
        │   └─► *Hata:* Hastanın sofra tuzunu kesmesini yeterli sanmak.
        │   └─► *Gerçek:* Sodyumun %75-80'i tüzlükten değil; ekmek, salça, turşu, peynir, maden suyu
        │                 ve kabartma tozundan (sodyum bikarbonat) gelir!.
        │
        ├─► [SİNSİ TUZAK 2: POTASYUM TUTUCU İLAÇ ALANA KCl TUZU VERMEK]
        │   └─► *Hata:* ACEi, ARB veya Spironolakton alan hastaya potasyumlu "diyet tuzu" önerisi.
        │   └─► *Sonuç:* ÖLÜMCÜL HİPERKALEMİ VE KARDİYAK ARREST!
        │
        ├─► [SİNSİ TUZAK 3: MADEN SUYU (SODA) AŞIRILIĞI]
        │   └─► *Hata:* Maden suyunu "zararsız mineral kaynağı" olarak serbest bırakmak.
        │   └─► *Gerçek:* Yüksek sodyumlu sodalar masif volüm yükü yaratır!
        │
        └─► [SİNSİ TUZAK 4: GREYFURT - KALSİYUM KANAL BLOKÖRÜ ETKİLEŞİMİ]
            └─► *Hata:* Amlodipin / Nifedipin alan hastaya greyfurt verilmesi.
            └─► *Sonuç:* CYP3A4 inhibisyonu ──► İlaç birikir ──► Şiddetli hipotansiyon & refleks taşikardi!
```
