...
source: "https://medium.com/data-science/understanding-llms-from-scratch-using-middle-school-math-e602d27ec876"
author:
  - "[[Rohit Patel]]"
published: 2024-10-19
created: 2026-01-05
description: "A self-contained, full explanation to inner workings of an LLM - assuming only that you know how to add and multiply two numbers."
tags:
  - "clippings"
---
[Sitemap](https://medium.com/sitemap/sitemap.xml)## [TDS Archive](https://medium.com/data-science?source=post_page---publication_nav-7f60cf5620c9-e602d27ec876---------------------------------------)

[![TDS Archive](https://miro.medium.com/v2/resize:fill:76:76/1*JEuS4KBdakUcjg9sC7Wo4A.png)](https://medium.com/data-science?source=post_page---post_publication_sidebar-7f60cf5620c9-e602d27ec876---------------------------------------)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*ymWXxVf7N4-Ps-62Cih2XQ.png)

Image by author

==Let’s now build a neural net that does this classification. We need to decide on input/output interpretations. Our inputs are already numbers, so we can feed them directly into the network. Our outputs are two objects, leaf and flower which the neural network cannot output. Let’s look at a couple of schemes we can use her== e:
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*9D2HQj6EBw0NC4c7YU0bWg.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*XPyJ-V0vbPv6EDwFpk7KYQ.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*0_tSCfEAL9NIK8U95Q-6Vg.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*lZOR8fNDEWHxUhLCSB-67A.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*VGNZ1Zighiek1sAMdiZCaw.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*7AJIjt5fiRhpc0h1qJKt3g.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*OgcRxWyftIXN8WbQw_-QKg.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*jSyo_owKB-tfTrPXV2giKg.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*270MXDfslVtvmBjShHL2hQ.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*145xBeyaNCU3mblFQyi2_A.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*j0oKuXvH7kfrIpIfXE03VA.png)

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*UodvtsDn5z73Cp578XOoVw.png)

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*qHPSwQmV3sfvKT5pG4TEJw.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*BmZd8SIDEQu7r5_R7y54kQ.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*U9mQKCWiyakNVwxU)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*Mq4hBZcKPL9GALPSSQG9Xg.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*psIz3-v2dMfI3SMsFQjRPQ.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*uPwJ24na4D_ECHBv1Lg5Fg.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*sXvYIassJutgqw5W)
...
- Now we collect a corpus of english language to train the model on. This is our training data. Often the key part of this dataset is a crawl of the entire internet, something like the [Common Crawl](https://commoncrawl.org/)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*woel5Da5Z22EmiGx)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*yn1TPuxw_QqnD93k)
...
[![TDS Archive](https://miro.medium.com/v2/resize:fill:96:96/1*JEuS4KBdakUcjg9sC7Wo4A.png)](https://medium.com/data-science?source=post_page---post_publication_info--e602d27ec876---------------------------------------)

[![TDS Archive](https://miro.medium.com/v2/resize:fill:128:128/1*JEuS4KBdakUcjg9sC7Wo4A.png)](https://medium.com/data-science?source=post_page---post_publication_info--e602d27ec876---------------------------------------)

[Last published Feb 3, 2025](https://medium.com/data-science/diy-ai-how-to-build-a-linear-regression-model-from-scratch-7b4cc0efd235?source=post_page---post_publication_info--e602d27ec876---------------------------------------)

An archive of data science, data analytics, data engineering, machine learning, and artificial intelligence writing from the former Towards Data Science Medium publication.

## Responses (103)

Write a response[What are your thoughts?](https://medium.com/m/signin?operation=register&redirect=https%3A%2F%2Fmedium.com%2Fdata-science%2Funderstanding-llms-from-scratch-using-middle-school-math-e602d27ec876&source=---post_responses--e602d27ec876---------------------respond_sidebar------------------)

```c
Wow1 Post60 Pages90 Min to read with interruptions2 Days to comprehend partly1 Month to absorb...
```

198

```c
Great article Rohit!! Thanks for sharing.Have all info at one place. For me this was better than going over 40 zillion articles..(:-))
```

51

```c
Can't believe I read the entire article in one sitting.This is beyond amazing. Always appreciate the efforts to simplify the complex. Thanks Rohit!
```

53

## More from Rohit Patel and TDS Archive
...
](https://medium.com/?source=post_page---read_next_recirc--e602d27ec876---------------------------------------)